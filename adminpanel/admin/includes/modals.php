      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Strand</label>
            <input type="" name="course_name" id="course_name" class="form-control" placeholder="Input Strand" required="" autocomplete="off">
          </div>
        </div>
      </div>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="" name="fullname" id="fullname" class="form-control" placeholder="Input Full Name" autocomplete="off" required="">
          </div>
          <div class="form-group">
            <label>Birhdate</label>
            <input type="date" name="bdate" id="bdate" class="form-control" placeholder="Input Birth date" autocomplete="off" >
          </div>
          <div class="form-group">
            <label>Gender</label>
